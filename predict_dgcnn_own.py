"""Run the DGCNN checkpoint trained by train_dgcnn_own_data.py against a
...
Usage:
  "C:/Users/USER/miniconda3/envs/EEG/python.exe" predict_dgcnn_own.py \
      --session-dir sessions/Shine_20260720_114710/trials/trial_01 \
...
def main():
    ...
    out_csv = Path(args.out_csv) if args.out_csv else session_dir / "dgcnn_own_predictions.csv"
