...
Usage:
  "C:/Dev/BCI/LibEER/.venv39/Scripts/python.exe" seed_montage_classify.py
  "C:/Dev/BCI/LibEER/.venv39/Scripts/python.exe" seed_montage_classify.py --feat de
"""
...
def main():
    ...
    print(f"Extracting all 15 SEED sessions ({a.feat})...")
    ...
    out_name = f"seed_montage_cls{suffix}.json"
